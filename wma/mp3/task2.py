...
img1 = cv.imread('res/photo_2_query.jpg', cv.IMREAD_GRAYSCALE) # queryImage
img2 = cv.imread('res/photo_2_train.jpg', cv.IMREAD_GRAYSCALE) # trainImage
...
cv.imshow("Matching keypoints", img3)
cv.waitKey(0)
